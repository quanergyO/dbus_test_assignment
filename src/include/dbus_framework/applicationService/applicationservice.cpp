...
QString ApplicationService::getService() noexcept { return dbusServiceStr; }

QString ApplicationService::getPath() noexcept { return dbusPathStr; }

QString ApplicationService::getInterface() noexcept { return dbusIfaceStr; }

QVariant ApplicationService::updateApplicationArgs(
    const std::tuple<QString, QString, QString> &applicationDbusData,
    const QString &method, const QStringList &arguments) {
  auto [dbusService, dbusPath, dbusIface] = applicationDbusData;
  QDBusMessage message =
      QDBusMessage::createMethodCall(dbusService, dbusPath, dbusIface, method);
