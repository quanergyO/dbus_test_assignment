...
void DbusFramework::registerService(const QString &name,
                                    const QString &dbusService,
                                    const QString &dbusPath,
                                    const QString &dbusInterface) {
  router_.insert_or_assign(
      name, std::make_tuple(dbusService, dbusPath, dbusInterface));
}

QVariant DbusFramework::callMethod(const QString &serviceName,
