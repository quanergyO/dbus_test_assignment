...
int main(int argc, char *argv[]) {
  ...
  controller->registerService("CreditCalc", "ru.credit.CreditCalc",
                              "/ru/credit/CreditCalc", "ru.credit.CreditCalc");
  controller->registerService("SmartCalc", "ru.model.SmartCalc",
                              "/ru/model/SmartCalc", "ru.model.SmartCalc");
